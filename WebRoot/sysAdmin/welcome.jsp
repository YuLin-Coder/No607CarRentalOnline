...
<html>
	<head>
		...
		<title>网上汽车租赁管理平台--企业管理人员</title>
		<link rel="stylesheet"  href="<%=path%>/businessStore/css/common.css">
		<link rel="stylesheet" href="<%=path%>/businessStore/css/style.css">
		<script type="text/javascript" src="<%=basePath%>businessStore/js/jquery.min.js"></script>
		<script type="text/javascript" src="<%=basePath%>businessStore/js/jquery.SuperSlide.js"></script>
