		...
		<div class="zc_head_bd">
			...
			<div class="zc_main">
				...
				<ul class="zc_menu">
					...
					<li>
						<a  href="<%=basePath%>member/StoreInfo.jsp" target="_top">营业门店</a>
					</li>
					<li>
						<a 
							href="<%=basePath%>servlet/MessageServlet?method=welShowMessage" target="_top">用户体验</a>
					</li>
					<li>
						<a  href="<%=basePath %>member/AboutUs.jsp" target="_top">关于我们</a>
					</li>
