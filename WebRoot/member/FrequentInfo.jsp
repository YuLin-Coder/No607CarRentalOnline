						...
						<div class="mod renter-list">
							...
							<p class="ui-checkbox">
								...
								<a href="javascript:void(0)" class="btn" data-toggle="modal"
									data-target="#agreementModal">《添加常用租车人须知》</a>
							</p>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<p style="text-indent: 2em;">
								如您需要添加常用租车人（以下简称第三人），您必须保证第三人的行为能力有效、全部身份信息真实有效、具备合法驾驶资质等；您将为第三人在贵账户内的操作行为（如注销、更改基本信息、下订单等）承担无限连带责任；您将为第三人与我司履行签署的服务协议及全部租车文件约定之权利义务承担无限连带责任，包括但不限于归还车辆、支付租赁费用、缴纳违章罚款、承担交通事故责任等。如您仍需添加常用租车人，即视为认可如上全部约定。
							</p>
						</div>
